...
class SortedArray():
    ...
    def insert(self, value):
        ...
        # the following will insert in to the self.data list
        # ie, it won't be calling this insert method...
...
if __name__ == '__main__':
    ...
    # Note: the LinearArray tests will fail until your implement the insert method
    # and the SortedArray will fail until you count comparisons
