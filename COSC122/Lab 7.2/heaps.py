...
class MinHeap(Heap):
    ...
    def validate(self):
        ...
        for i in range(len(self._items) - 1):
            left_child = i * 2
            right_child = (i * 2) + 1
            if self._items[left_child] != None and self._items[i] != None:
                if self._items[i] > self._items[left_child]:
                    pass
            elif self._items[right_child] != None and self._items[i] != None:
                if self._items[i] > self._items[right_child]:
                    pass
            else:
                valid = False
        return valid
