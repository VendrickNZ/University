...
def num_rushes(slope_height, rush_height_gain, back_sliding, start_height=0):
    ...
    """
    # ---start student section---
    total_height_gain = rush_height_gain - back_sliding
    if start_height >= slope_height and rush_height_gain < slope_height:
        return 0
    elif rush_height_gain >= slope_height:
        return 1
    else:
        if start_height + rush_height_gain >= slope_height:
            return 1
        else:
            return 1 + num_rushes(slope_height, rush_height_gain, 
            back_sliding, start_height+total_height_gain)
    # ===end student section===
