...
# your graph will plot on the
# a list of the size of lists to time sorting
...
#pyplot.plot(list_of_ns, avg_times_random, 'go')
...
quicksort(b,'left-pivot') 

quicksort(c,'left-pivot') 

quicksort(a,'mo3-pivot')

quicksort(b,'mo3-pivot')

quicksort(c,'mo3-pivot')