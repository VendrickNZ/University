...
class Album:
    ...
    def __str__(self):
        ...
        return ("----------------------------------------\n" +
                    ("Album Name: {}".format(self.name)) + "\n" +
            ("Band: {}".format(self.band))  + "\n" +
            ("Purchase Price: ${:.2f}".format(float(self.price))) + "\n" +
            ("First Recorded Sale: {}".format(self.first_date_recorded)) + "\n" +
            ("Last Recorded Sale: {}".format(self.last_date_recorded)) + "\n" +
            ("Total Sold: {}".format(self.total_sales)) + "\n" +
            "----------------------------------------")
...
a = input("Enter a data file name: ")
while os.path.isfile(a) == False:
