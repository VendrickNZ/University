...
void drawModel()
{
    ...
    glColor3f(0., 0., 1.);          //Right leg rotation
    glPushMatrix();
    ...
    glColor3f(0., 0., 1.);          //Left leg rotation
    glPushMatrix();
        glTranslatef(0.8, 4, 0);
        glRotatef(theta, 1, 0, 0);
        glTranslatef(-0.8, -4, 0);
        ...
        glutSolidCube(1);
    glPopMatrix();
    glColor3f(0., 0., 1.);          //Right arm rotation
    glPushMatrix();
    ...
    glColor3f(0., 0., 1.);          //Left arm rotation
    glPushMatrix();
      glTranslatef(2, 6.5, 0);
      glRotatef(-theta, 1, 0, 0);
      glTranslatef(-2, -6.5, 0);
